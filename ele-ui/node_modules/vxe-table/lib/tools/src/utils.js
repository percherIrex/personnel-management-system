    ...
    if (formatter) {
      if (_xeUtils.default.isString(formatter)) {
        ...
        if (!_xeUtils.default.isFunction(_globalFunc)) {
          UtilTools.error('vxe.error.notFunc', [_globalFunc]);
        }
      }
    }
  ...
  getCellLabel: function getCellLabel(row, column, params) {
    ...
    if (params && formatter) {
      ...
      if (_xeUtils.default.isString(formatter)) {
        ...
        var _globalFunc2 = _formats.default.get(formatter[0]) || _xeUtils.default[formatter[0]];

        cellLabel = _globalFunc2 ? _globalFunc2.apply(void 0, _toConsumableArray([cellValue].concat(formatter.slice(1)))) : '';
      } else {
