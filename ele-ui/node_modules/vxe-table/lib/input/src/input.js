  ...
  computed: {
    ...
    dateLabelFormat: function dateLabelFormat() {
      if (this.isDatePicker) {
        return this.dateOpts.labelFormat || _conf.default.i18n("vxe.input.date.labelFormat.".concat(this.type));
      }
    ...
    weekDatas: function weekDatas() {
      var sWeek = _xeUtils.default.toNumber(this.dateOpts.startWeek);
  ...
  methods: {
    ...
    afterCheckValue: function afterCheckValue() {
      ...
      if (!inpAttrs.readonly) {
        if (isNumber) {
          if (value || _xeUtils.default.isNumber(value)) {
            var inputValue = this.type === 'integer' ? _xeUtils.default.toInteger(value) : _xeUtils.default.toNumber(value);
    ...
    numberChange: function numberChange(isPlus) {
      ...
      var inputValue = this.type === 'integer' ? _xeUtils.default.toInteger(value) : _xeUtils.default.toNumber(value);
      var newValue = isPlus ? addition(inputValue, stepValue) : subtraction(inputValue, stepValue);
    ...
    dateParseValue: function dateParseValue(date) {
      var dateLabelFormat = this.dateLabelFormat,
          dateOpts = this.dateOpts;
      var dValue = date ? _xeUtils.default.toStringDate(date, dateOpts.parseFormat) : null;
      var dLabel = '';
    ...
    dateChangeValue: function dateChangeValue(date) {
      ...
      if (type === 'week') {
        date = _xeUtils.default.getWhatWeek(date, 0, dateOpts.startWeek);
      }
